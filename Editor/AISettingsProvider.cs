...
public class AiSettingsProvider : SettingsProvider
{
    ...
    private string customPrompt = "Write a short story about a brave knight.";
    ...
    private async void RunTestAsync(string promptText)
    {
        if (isTesting) return;
        ...
        try
        {
            ...
            {
                new ChatMessage(MessageRole.User, promptText)
            };
